...
Python model: ``plant_models.network_router_fluid_queue_with_delay``
...
.. list-table::
   ...
   * - :math:`y(t)`
     - ``y``
     - Queue-length deviation from its operating-point value with delayed arrival-rate actuation.
