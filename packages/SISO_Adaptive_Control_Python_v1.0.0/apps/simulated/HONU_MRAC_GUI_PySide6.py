...
class HONUMPCPage(QWidget):
    ...
    def _build_ui(self):
        ...
        for label, value in (("Auto (SciPy)", "auto"), ("RK45 (SciPy)", "RK45"), ("DOP853 (SciPy)", "DOP853"), ("Radau (SciPy)", "Radau"), ("BDF (SciPy)", "BDF"), ("LSODA (SciPy)", "LSODA")):
            self.ode_solver_combo.addItem(label, value)
        self.ode_solver_combo.setFixedWidth(205)
        self.ode_solver_combo.setToolTip("ODE solver for the selected physical model. Auto selects RK45, or Radau for designated stiff models.")
...
class MainWindow(QMainWindow):
    ...
    def _make_top_panel(self):
        ...
        self.ode_solver_combo_mrac.setToolTip("ODE solver used by physical-model data generation and MRAC testing. Auto selects RK45, or Radau for designated stiff models.")
