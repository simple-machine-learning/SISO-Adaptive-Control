...
Python model: ``plant_models.two_mass_actuator_grounded_m2_linear_viscous``
...
The seventh array element retained by the Python interface is unused and is not a physical state.
...
* `K. Ogata, System Dynamics (standard coupled mass-spring-damper formulation). <https://www.pearson.com/en-us/subject-catalog/p/system-dynamics/P200000003295>`_
