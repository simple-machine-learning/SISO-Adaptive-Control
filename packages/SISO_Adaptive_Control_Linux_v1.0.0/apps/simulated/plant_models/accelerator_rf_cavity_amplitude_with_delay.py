...
import numpy as np
from plant_models import accelerator_rf_cavity_amplitude as base

@dataclass
class PlantParams(base.PlantParams):
    plant_model_name: str = "accelerator_rf_cavity_amplitude_with_delay"
    input_delay_sec: float = 0.004
    delay_order: int = 3
